Public Class cbrUsuzovaniCompositional
    ...
    Public Overrides Function SpoctiVahyZaveru(ByVal novyPripad As Pripad, ByVal seznamPripadu As Collection, ByVal vahyAtributu As Collection) As Boolean
        Try
