    ...
    Protected Sub cmdOdeslat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdOdeslat.Click
        ...
        For Each str As String In atribut_text
            If str <> "" Then
                ...
                Select Case atribut.Typ
                    Case NestBase.Enums.enmTypAtributu.enmBinary
                        If s(1) <> "" OrElse konzultace.RezimKonzultace <> NestWebApplication.konzultace.enmRezimKonzultace.dotaznikSDialogem Then
                            If s(1) = "" Then
                    ...
                    Case NestBase.Enums.enmTypAtributu.enmMultiple
                        ...
                        If konzultace.RezimKonzultace = NestWebApplication.konzultace.enmRezimKonzultace.dotaznikSDialogem Then
                            Dim strp As String = s(1).Replace("|", "")
                            If strp = "" Then read = False
                        End If
                        If read Then
