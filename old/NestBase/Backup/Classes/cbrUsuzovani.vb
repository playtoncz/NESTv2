Public MustInherit Class cbrUsuzovani
    ...
    Public MustOverride Function SpoctiVahyZaveru(ByVal novyPripad As Pripad, ByVal seznamPripadu As Collection, ByVal vahyAtributu As Collection) As Boolean
