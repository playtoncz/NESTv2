...
#End Region
    ...
    Private Function ProvedKonzultaci(ByRef ResultXML As String) As Boolean
        Dim cil As Vyrok
        ...
        For Each cil In Me.mCile
            ...
            If Not cil.VyhodnotVyrokBackward(vyhodnocenyCil, neurcitost, Me.mAktualniDotazy, Me.mAtributy, False) Then
    ...
    Public Function RunConsultation(ByVal BazeZnalostiXML As String, ByVal AnswersXML As String, ByRef ResultXML As String, Optional ByVal NscXml As String = "") As Boolean
        Try
            'nacte bazi znalosti
            ...
            If Not ProvedKonzultaci(ResultXML) Then
                Return False
            End If
