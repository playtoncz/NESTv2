...
#End Region
    ...
    Public Function VyhodnotVyrokBackward(ByRef uspesneVyhodnocen As Boolean, ByVal neurcitost As Neurcitost, ByVal aktSeznamDotazu As Collection, ByVal atributy As Collection, ByVal bezdotazu As Boolean, Optional ByRef PripadVzdalenost As Collection = Nothing) As Boolean
        Try
            Dim zdroj As Zdroj
            For Each zdroj In Me.mZdroje
                Dim vyhodnoceniZdroje As Boolean
                Dim dalsiZdroj As Boolean = True
                If Not zdroj.VyhodnotZdroj(vyhodnoceniZdroje, Me, neurcitost, aktSeznamDotazu, atributy, bezdotazu, dalsiZdroj, , PripadVzdalenost) Then
