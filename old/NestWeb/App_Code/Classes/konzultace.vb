...
Public Class konzultace
    ...
    Public Function Konzultuj(ByRef RedirectString As String, ByRef result As String, ByRef id_dotazu As String, Optional ByVal PrvniVolani As Boolean = False) As Boolean
        ...
        If BZ2.RunConsultation(BazeZnalostiXML, odpovedi, result, NcsXML) Then
            Dim dotaz As NestBase.Atribut
            Dim jeDotaz As Boolean
            If Not IsQuestion(result, dotaz, jeDotaz) Then
                Return False
